...
export type MinterRpc = JsonRpcProvider;
...
export interface MinterRpcModuleOptionsFactory {
  createMinterRpcModuleOptions(): Promise<MinterRpcModuleOptions> | MinterRpcModuleOptions;
}

export interface MinterRpcModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
  inject?: any[];
  useClass?: Type<MinterRpcModuleOptionsFactory>;
  useExisting?: Type<MinterRpcModuleOptionsFactory>;
  useFactory?: (...args: any[]) => Promise<MinterRpcModuleOptions> | MinterRpcModuleOptions;
}
